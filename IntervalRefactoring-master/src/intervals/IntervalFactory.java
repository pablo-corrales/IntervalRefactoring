...
public class IntervalFactory {
	...
	public static Interval getInterval(double minimum, double maximum, Opening opening) {
				...
				case LEFT_OPENED: return getLeftOpenedInterval(new FromPoint(minimum), new Until_ExactPoint(maximum));
				case RIGHT_OPENED: return getRigthOpenedInterval(new From_ExactPoint(minimum), new UntilPoint(maximum));
				case UNOPENED: return getUnOpenedInterval(new From_ExactPoint(minimum), new Until_ExactPoint(maximum));
				default: return null;
			}
	}
